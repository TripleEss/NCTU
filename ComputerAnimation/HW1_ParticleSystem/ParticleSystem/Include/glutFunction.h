#ifndef GLUT_FUNCTION_H
#define GLUT_FUNCTION_H
...
{    
    ...
    TextureImage[SKYBOX + 0].load("Texture/skybox0.bmp");
	TextureImage[SKYBOX + 1].load("Texture/skybox1.bmp");
	TextureImage[SKYBOX + 2].load("Texture/skybox2.bmp");
	TextureImage[SKYBOX + 3].load("Texture/skybox3.bmp");
	TextureImage[SKYBOX + 4].load("Texture/skybox4.bmp");
	TextureImage[SKYBOX + 5].load("Texture/skybox5.bmp");
    TextureImage[DICE + 0].load("Texture/dice0.bmp");
	TextureImage[DICE + 1].load("Texture/dice1.bmp");
	TextureImage[DICE + 2].load("Texture/dice2.bmp");
	TextureImage[DICE + 3].load("Texture/dice3.bmp");
	TextureImage[DICE + 4].load("Texture/dice4.bmp");
	TextureImage[DICE + 5].load("Texture/dice5.bmp");
    TextureImage[GROUND].load("Texture/ground.bmp");
	TextureImage[PUZZLE + 0].load("Texture/puzzle0.bmp");
	TextureImage[PUZZLE + 1].load("Texture/puzzle1.bmp");
	TextureImage[PUZZLE + 2].load("Texture/puzzle2.bmp");
	TextureImage[PUZZLE + 3].load("Texture/puzzle3.bmp");
	TextureImage[PUZZLE + 4].load("Texture/puzzle4.bmp");
