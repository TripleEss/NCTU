        ...
        )
{
    ...
    *switch_map_ = SwitchMap_t(
	...
	light_button_map_->at("cartoon_filter").value(this->is_switch_on("cartoon_filter"));
...
void MainWindow::InitLightButton()
{
    boost::assign::ptr_map_insert<Fl_Light_Button>(*light_button_map_)
		...
		("cartoon_filter", 655, 460, 90, 25, "Cartoon filter");
    ...
    *light_button_slot_map_ = SlotFuncMap_t(
        {
			...
			{"cartoon_filter", &MainWindow::CartoonFilterSlot},
        }
    );
...
void MainWindow::DeactivateWidget()
{
	...
	light_button_map_->at("cartoon_filter").deactivate();
}
...
void MainWindow::LoadMotionSlot(Fl_Widget *widget)
{
	...
	light_button_map_->at("cartoon_filter").activate();
}
...
void MainWindow::ResetSkeletonSlot(Fl_Widget *widget)
{
	...
	this->set_switch("cartoon_filter", false);
	light_button_map_->at("cartoon_filter").value(switch_map_->at("cartoon_filter"));
	light_button_map_->at("cartoon_filter").deactivate();
...
void MainWindow::CartoonFilterSlot(Fl_Widget *widget)
{
	switch_map_->at("cartoon_filter")
		= boost::numeric_cast<bool>(light_button_map_->at("cartoon_filter").value());

	display_->SolveCartoonFilter();
}
